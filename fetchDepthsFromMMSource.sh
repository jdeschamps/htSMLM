...
if ! [ -d "$MM2_HOME" ]; then
	...
	MMJ="$MM2_HOME/mmstudio/MMJ_.jar"
	MMAcqEngine="$MM2_HOME/acqEngine/MMAcqEngine.jar"
	MMCoreJ="$MM2_HOME/mmCoreAndDevices/MMCoreJ_wrap/MMCoreJ.jar"
	EMU="$MM2_HOME/plugins/Emu.jar"
